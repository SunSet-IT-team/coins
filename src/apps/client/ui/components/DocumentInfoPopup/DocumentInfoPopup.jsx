                        ...
                        return (
                            <label
                                ...
                                className={classNames(styles.cardItemWrapper, {
                                    [styles.cardItemWrapperHovered]:
                                        !uploadedDoc || doc.id === 'others',
                                    [styles.activeItemCard]:
                                        doc.id === 'others'
                                            ? uploadedDoc && uploadedDoc.length
                                            : uploadedDoc,
                                })}
                                onDrop={
                                    !uploadedDoc || doc.id === 'others'
                                        ? this.handleFileDrop(doc.id)
                                        : undefined
                                }
                                onDragOver={
                                    !uploadedDoc || doc.id === 'others'
                            ...
                            >
                                ...
                                <div className={styles.cardItem}>
                                    <div className={styles.title}>
                                        {doc.id === 'identity' && text.personality}
                                        {doc.id === 'residence' && text.address}
                                        {doc.id === 'cardFront' && text.creditFrontSide}
                                        {doc.id === 'cardBack' && text.creditBackSide}
                                        <svg
                                            width="16"
                                            height="16"
                                            viewBox="0 0 16 16"
                                    ...
                                    <img
                                        ...
                                        src={
                                            (
                                                ...
                                                ? '/src/apps/client/ui/components/DocumentInfoPopup/images/ok.svg'
                                                : doc.img
                                        }
                                        alt="doc image"
                                    />
                                        ...
                                        <div className={styles.bottomLabel}>
                                            ...
                                            {/* eslint-disable-next-line max-len */}
                                            {
                                                ...
                                                >
                                                    {/* eslint-disable-next-line max-len */}
                                                    <path
                                                        d="M9.5 1.2875L8.7125 0.5L5 4.2125L1.2875 0.5L0.5 1.2875L4.2125 5L0.5 8.7125L1.2875 9.5L5 5.7875L8.7125 9.5L9.5 8.7125L5.7875 5L9.5 1.2875Z"
                                                        fill="#F8F8F8"
                                                        fillOpacity="0.75"
                                                    />
                                                </svg>
                                            ...
                                            {uploadedDoc.map((uploadedDocOther, i) => {
                                                return (
                                                    <div key={i}>
                                                        ...
                                                        <svg
                                                            className={styles.docRemove}
                                                            onClick={this.handleRemoveOtherDoc(i)}
                                                            width="10"
                                                            height="10"
                                                            viewBox="0 0 10 10"
                                                            fill="none"
                                    ...
                                    {!uploadedDoc && (
                                        <div className={styles.bottomLabel}>{text.clickOrDrag}</div>
                                    )}
                                </div>
                            </label>
                        );
