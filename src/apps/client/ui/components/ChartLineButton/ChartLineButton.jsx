...
class ChartLineButton extends Component {
    ...
    componentDidMount() {
        this.props.events.on(SCROLL_TOP_LOCKED_EVENT_NAME, () =>
            this.setState({isChartLineOpen: false})
        );
    }
            ...
            <div>
                ...
                >
                    <div className={styles.contentContainer}>
                        <div
                            className={classNames(styles.lineItem, styles.candlesticks, {
                        ...
                        >
                            ...
                            >
                                ...
                                <path
                                    d="M13.7261 4.18553H11.9883V0.714233H10.2505V4.18553H8.5127V14.5994H10.2505V18.0707H11.9883V14.5994H13.7261V4.18553Z"
                                    fill="#A6B1DC"
                                />
                                {/* eslint-disable-next-line max-len */}
                                <path
                                    d="M5.7847 7.13622H4.0469V3.66492H2.30909V7.13622H0.571289V15.8145H2.30909V19.2858H4.0469V15.8145H5.7847V7.13622ZM4.0469 14.0788H2.30909V8.87187H4.0469V14.0788Z"
                                    fill="#A6B1DC"
                                />
                            </svg>
                        </div>
                        <div
                            className={classNames(styles.lineItem, styles.heikinashi, {
                        ...
                        >
                            ...
                            >
                                {/* eslint-disable-next-line max-len */}
                                <path
                                    d="M12.4402 6.14277H10.7024V0.714233H8.96461V6.14277H7.22681V13.2142H8.96461V18.0707H10.7024V13.2142H12.4402V6.14277Z"
                                    fill="#A6B1DC"
                                />
                                {/* eslint-disable-next-line max-len */}
                                <path
                                    d="M5.7847 8.99983H4.0469V3.57129H2.30909V8.99983H0.571289V16.0713H2.30909V20.9278H4.0469V16.0713H5.7847V8.99983Z"
                                    fill="#A6B1DC"
                                />
                            </svg>
                        </div>
                        <div
                            className={classNames(styles.lineItem, styles.hlc, {
                        ...
                        >
                            ...
                            >
                                ...
                                <path
                                    fillRule="evenodd"
                                    clipRule="evenodd"
                                    d="M4.61232 1.28577H5.95926V5.32657H5.95929V6.67351H5.95926V13.4082H7.3062V14.7551H5.95926V17.449H4.61232V14.7551V13.4082V6.67351H0.571533V5.32657H4.61232V1.28577Z"
                                    fill="#A6B1DC"
                                />
                                {/* eslint-disable-next-line max-len */}
                                <path
                                    fillRule="evenodd"
                                    clipRule="evenodd"
                                    d="M11.0408 0H12.3877V4.0408H12.3878V5.38774H12.3877V12.1224H13.7347V13.4693H12.3877V16.1633H11.0408V13.4693V12.1224V5.38774H7V4.0408H11.0408V0Z"
                                    fill="#A6B1DC"
                                />
                            </svg>
                        </div>
                        <div
                            className={classNames(styles.lineItem, styles.line, {
                        ...
                        >
                            ...
                            >
                                {/* eslint-disable-next-line max-len */}
                                <path
                                    d="M1.42847 17.7143L6.3992 6.53013C6.46785 6.37567 6.68526 6.37073 6.76085 6.52191L10.2401 13.4804C10.3155 13.6311 10.5322 13.6267 10.6013 13.473L16.0341 1.40018C16.1045 1.24376 16.3262 1.24271 16.3981 1.39844L23.9285 17.7143"
                                    stroke="#A6B1DC"
                                />
                            </svg>
                        </div>
                        <div
                            className={classNames(styles.lineItem, styles.area, {
                        ...
                        >
                            ...
                            >
                                {/* eslint-disable-next-line max-len */}
                                <path
                                    d="M1.42847 17.7143L6.48526 6.33649C6.51959 6.25927 6.62829 6.2568 6.66609 6.33239L10.3343 13.6687C10.372 13.7441 10.4803 13.7419 10.5149 13.6651L16.1241 1.20009C16.1593 1.12188 16.2702 1.12135 16.3061 1.19922L23.9285 17.7143"
                                    stroke="#A6B1DC"
                                    strokeDasharray="3 1"
                                />
                            </svg>
