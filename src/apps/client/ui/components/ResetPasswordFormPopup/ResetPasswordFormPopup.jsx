        ...
        return (
            ...
            >
                ...
                <form className={styles.form} onSubmit={this.handleSubmit}>
                    <div className={styles.emailContainerField}>
                        <FormInput
                            ...
                            texts={{
                                ...
                                emailValidator: error || `${text.inputs.email.validator}`,
                            }}
                            name="email"
                    ...
                    <div className={styles.forgetPassordButton} onClick={this.handleBackClick}>
                        {text.back}
                    </div>
                </form>
                <div
                        ...
                        <div className={styles.popup}>
                            <div className={styles.popupContent}>
                                <div className={classNames(styles.content)}>
                                    ...
                                    <img
                                        src="/src/apps/client/ui/components/ResetPasswordFormPopup/images/circle.svg"
                                        alt=""
                                    />
                                </div>
                            </div>
