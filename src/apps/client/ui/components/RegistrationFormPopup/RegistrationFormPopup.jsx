...
class RegistrationFormPopup extends Component {
    ...
    componentDidMount() {
        ...
        this.phoneContainerRef.current.firstChild.firstChild.style.paddingLeft =
            this.callingCodeRef.current.offsetWidth + 61 + 'px';
    }
    ...
    handleSetCountry = (country) => {
        this.setState({
            ...
            phone: {...this.state.phone, value: this.state.phone.value},
        });
    };
    ...
    handleIsMobileVersion = () => {
        ...
        if (this.props.mediaWidth < MOBILE_VERRSION && !dateInputMaskValue.value) {
            this.setState({
                ...
                dateInputMaskValue: {
                    ...dateInputMaskValue,
                    value: this.getDate(date.value) || '__.__.____',
                },
            });
        }
    };
        ...
        return [
            <form key={0} className={styles.form} onSubmit={this.handleSubmit}>
                <FormInput
                    ...
                    texts={{
                        name: `${text.inputs.name.placeholder}`,
                        nameValidator: `${text.inputs.name.validator}`,
                    }}
                    name="name"
                ...
                <FormInput
                    ...
                    texts={{
                        surname: `${text.inputs.surname.placeholder}`,
                        surnameValidator: `${text.inputs.surname.validator}`,
                    }}
                    name="surname"
                    onFocus={this.onFocus}
                    onBlur={this.onBlur}
                ...
                <div className={styles.passwordContainerField}>
                    <FormInput
                        ...
                        texts={{
                            password: `${text.inputs.password.placeholder}`,
                            passwordValidator: `${text.inputs.password.validator}`,
                        }}
                        name="password"
                        onFocus={this.onFocus}
                        onBlur={this.onBlur}
                ...
                <div className={styles.dateContainerField}>
                    ...
                    <img
                        src="/src/apps/client/ui/components/RegistrationFormPopup/images/date.svg"
                        alt=""
                    />
                    <div
                        className={classNames(styles.dateBottomLabel, {
                            [styles.dateBottomLabelActive]:
                                !this.state['date'].isValid ||
                                !this.state['dateInputMaskValue'].isValid,
                        })}
                    >
                ...
                <div className={styles.checkboxesContainer}>
                    <div onClick={this.handlerCheckBoxClick('confirm')}>
                        <img
                            className={styles.emptyCheck}
                            src="/src/apps/client/ui/components/RegistrationFormPopup/images/empty.png"
                            alt=""
                        />
                        <img
                            className={classNames(styles.fillCheck, {
                                [styles.activeCheckbox]: confirm.value,
                            })}
                            src="/src/apps/client/ui/components/RegistrationFormPopup/images/checked.png"
                            alt=""
                        />
                        {text.iAccept}
                        <span>{text.termsOfAgreement}</span>
                    </div>
                    <div
                        className={classNames(styles.checkboxError, {
