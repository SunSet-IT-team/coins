...
import styles from './WithdrawChoisePopup.css';
...
const PAYMENTS_SYSTEM = [
    { id: 1, name: 'Visa/Mastercard', icon: '/src/apps/client/ui/components/PaymentsPopup/images/visa.svg' },
    { id: 2, name: 'USDT TRC-20', icon: '/src/apps/client/ui/components/PaymentsPopup/images/bit.svg' },
    { id: 3, name: 'Bank Transfer (amount from 10.000$)', icon: '/src/apps/client/ui/components/PaymentsPopup/images/visa.svg' }
];
                            ...
                            <div className={styles.formContainer}>
                                ...
                                <div className={classNames(styles.hiddenInfo, { [styles.hiddenInfoOpen]: this.state.showHidden })}>
                                    ...
                                    <div className={styles.adressWrapper}>
                                        {
                                            this.state.activePayment === 'Visa/Mastercard' /* bitcoin */
