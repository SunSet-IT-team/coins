...
class AssetsButton extends Component {
    ...
    handleSymbolSelect = (symbol) => () => {
        ...
        this.setState({
            filteredChartSymbolGroup: this.state.filteredChartSymbolGroup.map((chartSymbol) =>
                chartSymbol.name === symbol.name
                    ? {
                          ...chartSymbol,
                          isActive: true,
                      }
    ...
    filterList = () => {
        const filteredChartSymbolGroup = this.props.chartSymbolGroup.symbols.filter(
            (chart) => chart.title.toLowerCase().indexOf(this.state.textSearch.toLowerCase()) !== -1
        );
    ...
    render() {
        ...
        const {isAssetsOpen, isInnerAssetsButtonOpen, filteredChartSymbolGroup, textSearch} =
            this.state;
                ...
                >
                    ...
                    <div className={styles.contentContainer}>
                        <div className={styles.contentItem} onClick={this.handlerAssetsInnerButton}>
                            <div
                                className={classNames(styles.contentItemText, {
                            ...
                            >
                                ...
                                >
                                    <img
                                        src="/src/apps/client/ui/components/AssetsButton/images/arrowDown.svg"
                                        alt=""
                                    />
                                </div>
                            </div>
                            <div
                                className={classNames(styles.innerAssetsContainer, {
                                    [styles.innerAssetsButtonVisible]: isInnerAssetsButtonOpen,
                                })}
                            >
                                {CHART_SYMBOL_GROUPS.filter(
                                    (symbolGroup) => symbolGroup.id !== chartSymbolGroup.id
                                ).map((item, i) => (
                                    <div
                                        key={i}
                                        className={styles.assetsItem}
                                        onClick={this.handleSymbolGroupSelect(item)}
                                    >
                                        <div className={styles.iconContainer}>
                                            <img src={item.img} />
                                        </div>
