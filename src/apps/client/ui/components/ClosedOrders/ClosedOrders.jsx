...
const mapDispatchToProps = (dispatch) => ({
    getClosedOrdersByPage: (page, perPage, closedOrders) =>
        dispatch(getClosedOrdersByPage(page, perPage, closedOrders)),
});
...
class ClosedOrders extends Component {
    ...
    async loadMore() {
        this.state.page += 1;
        this.props.getClosedOrdersByPage(
            this.state.page,
            this.state.perPage,
    ...
    render() {
        ...
        return (
            <div className={styles.closePositionInnerContaimer}>
