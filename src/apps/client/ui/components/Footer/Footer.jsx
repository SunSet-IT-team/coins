...
class Footer extends Component {
    ...
    componentDidMount() {
        this.props.events.on(SCROLL_TOP_LOCKED_EVENT_NAME, () =>
            this.setState({isFooterContentVisible: false})
        );

        assetPriceWebsocketController.events.on(
            'ordersAndBalance',
    ...
    componentDidUpdate() {
        if (
            this.props.mediaWidth > MIN_DESKTOP &&
            this.state.isFooterContentVisible &&
            !this.props.outsideClickEnabled
        ) {
    ...
    loadMore() {
        this.props.events.emit('SCROLL_DOWN_ORDERS_CLOSE');
    }
            ...
            <section>
                <div
                    className={classNames(styles.root, {
                        ...
                        [styles.footerRootContainerFullSize]:
                            isFooterContentVisible && isFullScreen,
                    })}
                >
                    <div className={styles.rootContainer}>
                        ...
                        >
                            <div
                                ...
                                className={classNames(styles.leftContainerItem, {
                                    [styles.activePositionButton]:
                                        activeSlidePosition === 1 && isFooterContentVisible,
                                })}
                            >
                                {text.openPosition}
                                <span className={styles.itemValue}>{openOrdersLength}</span>
                            </div>
                            <div
                                onClick={this.handlePositionClick(2)}
                                className={classNames(styles.leftContainerItem, {
                                    [styles.activePositionButton]:
                                        activeSlidePosition === 2 && isFooterContentVisible,
                                })}
                            >
                                {text.closePosition}
                                <span className={styles.itemValue}>{countClosedOrders}</span>
                            </div>
                            <div className={styles.leftContainerItem}>
                                {text.pu}
                                <span
                        ...
                        <div
                            className={classNames(
                                ...
                                styles.middleContainerDesktop
                            )}
                        >
                            <div className={classNames(styles.middleContainerButton, styles.pu)}>
                                {text.pu}
                                <span
                            ...
                            >
                                ...
                                <br />
                                <span className={styles.buttonItem}>
                                    $ {formatNumberToString(credFacilities)}
                                </span>
                            </div>
                            <div className={classNames(styles.middleContainerButton, styles.free)}>
                                {text.free}
                                <br />
                                <span className={styles.buttonItem}>
                                    $ {formatNumberToString(freeBalance)}
                                </span>
                            </div>
                            <div
                                className={classNames(styles.middleContainerButton, styles.pledge)}
                            >
                                {text.pledge}
                                <br />
                                <span className={styles.buttonItem}>
                                    $ {formatNumberToString(totalPledge)}
                                </span>
                            </div>
                            <div
                                className={classNames(
                            ...
                            >
                                ...
                                <br />
                                <span className={styles.buttonItem}>
                                    % {formatNumberToString(marginLevel)}
                                </span>
                            </div>
                        </div>
                        <div className={styles.rightContainer}>
                            <div className={styles.buttonContainer} onClick={this.handleResize()}>
                                ...
                                >
                                    ...
                                    <path
                                        d="M16.7889 4.76667L20 1.57778L18.4222 0L15.2333 3.21111L12.6778 0.655556V7.32222H19.3444L16.7889 4.76667ZM0.655556 7.32222H7.32222V0.655556L4.76667 3.21111L1.57778 0L0 1.57778L3.21111 4.76667L0.655556 7.32222ZM1.57778 20L4.76667 16.7889L7.32222 19.3444V12.6778H0.655556L3.21111 15.2333L0 18.4222L1.57778 20ZM18.4222 20L20 18.4222L16.7889 15.2333L19.3444 12.6778H12.6778V19.3444L15.2333 16.7889L18.4222 20Z"
                                        fill="#A6B1DC"
                                    />
                                </svg>
                            </div>
                    ...
                    <div
                        className={classNames(styles.rootLeftColumn, {
                    ...
                    <div className={classNames(styles.footerOrderContainer)}>
                        <div ref={this.positionSliderRef} className={styles.footerOpenContainer}>
                            <div
                                ref={this.openOrdersSliderRef}
                                className={classNames(styles.openPositionSlide, {
                                    [styles.positionsFullSize]:
                                        isFooterContentVisible && isFullScreen,
                                })}
                            >
                                <OpenedOrders events={events} />
                            </div>
                            <div
                                className={classNames(styles.closePositionSlide, {
                                    [styles.positionsFullSize]:
                                        isFooterContentVisible && isFullScreen,
                                })}
                                ref={(ref) => (this.closeOrdersSliderRef = ref)}
                            >
                                <InfiniteScroll
                                    pageStart={1}
                                    loadMore={this.loadMore.bind(this)}
                                    hasMore={closedOrders.length < countClosedOrders}
                                    initialLoad={false}
                                    loader={
                                        <div className={styles.loaderClosedOrders} key={0}>
                                            Loading ...
                                        </div>
                                    }
                                    useWindow={false}
                                    getScrollParent={() => this.closeOrdersSliderRef}
                                >
                                    <ClosedOrders events={events} />
                                </InfiniteScroll>
                            </div>
                        </div>
                    </div>
                ...
                <div className={styles.mobileAssetsButton}>
                    ...
                    <div className={styles.mobileOperations}>
                        <div
                            className={classNames(styles.mobileOperationsButton, {
                ...
                >
                    ...
                    <div className={classNames(styles.middleContainerButton, styles.facilities)}>
                        {text.balance}
                        <span className={styles.buttonItem}>
                            $ {formatNumberToString(mainBalance)}
                        </span>
                    ...
                    <div className={classNames(styles.middleContainerButton, styles.facilities)}>
                        {text.bonuses}
                        <span className={styles.buttonItem}>$ {formatNumberToString(bonuses)}</span>
                    </div>
                    <div className={classNames(styles.middleContainerButton, styles.facilities)}>
                        {text.credFacilities}
                        <span className={styles.buttonItem}>
                    ...
                    <div className={classNames(styles.middleContainerButton, styles.pledge)}>
                        {text.pledge}
                        <span className={styles.buttonItem}>
                            $ {formatNumberToString(totalPledge)}
                        </span>
