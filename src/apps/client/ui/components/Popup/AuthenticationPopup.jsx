...
import AuthFormPopup from '../AuthFormPopup/AuthFormPopup';
                        ...
                        <div className={styles.popupContent}>
                            <div className={classNames(styles.content)}>
                                ...
                                <div className={styles.formsContainer}>
                                    <div
                                        className={classNames(styles.authPopupContainer, {
                                    ...
                                    <div
                                        className={classNames(styles.registrationPopupContainer, {
