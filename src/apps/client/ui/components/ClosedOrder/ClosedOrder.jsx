...
class ClosedOrder extends PureComponent {
    ...
    render() {
        ...
        return (
            <div className={styles.footerItemTable}>
                ...
                <div className={classNames(styles.itemCloseDate, styles.footerItems)}>
                    {this.getDate(item.closedAt)}
                </div>
                ...
                <div className={classNames(styles.itemClosingRate, styles.footerItems)}>
                    ...
                    >
                        {item.diffPrice > 0 && '+'} {formatPriceToString(item.diffPrice)}
                    </div>
                </div>
                <div
