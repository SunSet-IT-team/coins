...
import setPaymentsPopup from "../../../actions/setPaymentsPopup.js"
...
const PAYMENTS_SYSTEM = [
  {
    id: 1,
    name: "usdt",
    icon: "/src/apps/client/ui/components/PaymentsPopup/images/usdt.svg",
  },
  {
    id: 2,
    name: "bitcoin",
    icon: "/src/apps/client/ui/components/PaymentsPopup/images/bitcoin.svg",
  },
  {
    id: 3,
    name: "swift",
    icon: "/src/apps/client/ui/components/PaymentsPopup/images/SWIFT_logo.svg",
  },
]
...
class PaymentsPopup extends Component {
  ...
  handleSubmit = (e) => {
    ...
    window.open(
      `https://qiwi.com/payment/form/99?amountInteger=${amount}&amountFraction=00&currency=643&provider=99&extra[%27account%27]=+${payments.qiwi}&extra[%27comment%27]=${message}&blocked[0]=sum&blocked[1]=account&blocked[2]=comment`
    )
  }
            ...
            <div className={styles.popupContent}>
              <div className={classNames(styles.content)}>
                ...
                <div className={styles.formContainer}>
                          ...
                          >
                            <div className={styles.textContainer}>
                              <div className={styles.paymentTitle}>
                                {text[payment.name].title}
                              </div>
                              {text[payment.name].subtitle && (
                  ...
                  <div
                    className={classNames(styles.hiddenInfo, {
                      [styles.hiddenInfoOpen]: this.state.showHidden,
                    })}
                  >
                    <div className={styles.qrBlock}>
                      ...
                      {this.state.activePayment === "bitcoin" && (
                        <img
                          width="200"
                          height="200"
                          src={`../../../../../${payments.qr.btc.path}`}
                          alt="QR code"
                        />
                      )}
                    </div>
                    <div
                      className={classNames(styles.titleTop, {
                        [styles.isTitleFocus]: focusField,
                        [styles.errorField]:
                          fieldError && activePayment === "qiwi",
                      })}
                    >
                    ...
                    <div className={styles.adressWrapper}>
                      {this.state.activePayment === "bitcoin" && (
                        <div className={styles.bitcoinAdressContainer}>
                          ...
                          <div
                            ...
                            onClick={() =>
                              this.copyToClipBoard(payments.bitcoin)
                            }
                          />
                        </div>
                      )}
                      {this.state.activePayment === "usdt" && (
                        <div className={styles.bitcoinAdressContainer}>
                          ...
                          <div
                            className={styles.copy}
                            onClick={() => this.copyToClipBoard(payments.usdt)}
                          />
                        </div>
                      )}
                  ...
                  <div
                    className={classNames(styles.dontShowCopiedText, {
                      [styles.showCopiedText]: this.state.showCopied,
                    })}
                  >
                    {text.info.copied}
                  </div>
