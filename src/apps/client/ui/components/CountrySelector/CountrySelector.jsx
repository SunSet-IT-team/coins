    ...
    render() {
        ...
        return (
            ...
            >
                ...
                >
                    {COUNTRY_INFO.filter((country) => country.id !== activeCountry.id).map(
                        (country) => (
                            <div
                                key={country.id}
                                className={styles.countryContainer}
                                onClick={this.handleSetCountry(country)}
                            >
                                <img
                                ...
                                <div className={styles.countryNameBlock}>
                                    <div className={styles.countryNameText}>
                                        {langsMap.en.accountInfo.countryInfo[country.name]}
                                    </div>
                                </div>
                            </div>
                        )
