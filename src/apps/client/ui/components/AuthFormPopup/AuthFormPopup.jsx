        ...
        return [
            ...
            >
                ...
                <div className={styles.buttonContainer}>
                    {error && (
                        <div className={styles.errorMessage}>{text.errorWrongPassOrLogin}</div>
                    )}
                    <button className={classNames(styles.button)} type="submit">
                        {text.signIn}
                    </button>
                </div>
                <div className={styles.forgetPassordButton} onClick={this.handleForgetPassword}>
                    {text.forgetPassword}
                </div>
            </form>,
            <ResetPasswordFormPopup
                key={1}
                isOpen={isForgetPassword}
                handleBackClick={this.handleForgetPassword}
