...
class BuyAndSellComponent extends Component {
    ...
    handleSetValue = (value) => () => {
        const amount = isUndefined(this.state.amount)
            ? MIN_AVAILABLE_PRICE
                ...
                <div className={styles.buyAndSell}>
                    ...
                    <div className={styles.counterContainer}>
                        <label
                            ...
                            htmlFor="input"
                            onClick={this.handleSetValue(+0.01)}
                        >
                            <svg
                                width="12"
                                height="8"
                            ...
                            >
                                ...
                                <path
                                    d="M1.7925 7.2085L6 3.24246L10.2075 7.2085L11.5 5.98751L6 0.79183L0.5 5.98751L1.7925 7.2085Z"
                                    fill="#F8F8F8"
                                    fillOpacity="0.75"
                                />
                            </svg>
                        ...
                        <label
                            className={classNames(styles.arrows, styles.arrowDown)}
                            htmlFor="input"
                            onClick={this.handleSetValue(-0.01)}
                        >
                            <svg
                            ...
                            >
                                {/* eslint-disable-next-line max-len */}
                                <path
                                    d="M1.7925 0.791504L6 4.75754L10.2075 0.791504L11.5 2.01249L6 7.20817L0.5 2.01249L1.7925 0.791504Z"
                                    fill="#F8F8F8"
                                    fillOpacity="0.5"
                                />
                            </svg>
