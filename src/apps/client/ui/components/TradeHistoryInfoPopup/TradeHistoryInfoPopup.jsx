...
class TradeHistoryInfoPopup extends Component {
    ...
    render() {
        ...
        return (
            <div className={styles.tradeHistoryPopupContainer}>
                    ...
                    {closedOrders
                        ...
                        .map((item, i) => (
                            <div key={i} className={styles.tradeItem}>
                                ...
                                <div
                                    className={classNames(styles.itemCloseDate, styles.footerItems)}
                                >
                                ...
                                <div
                                    className={classNames(
                                        styles.itemOpeningRate,
                                        styles.footerItems
                                    )}
                                >
                                    {formatNumberToString(item.openingPrice)}
                                </div>
                                <div
                                    className={classNames(
                                        styles.itemClosingRate,
                                        styles.footerItems
                                    )}
                                >
                                    <div className={styles.itemClosingRateText}>
                                ...
                                <div
                                    className={classNames(
                                        styles.itemCommission,
                                        styles.footerItems
                                    )}
                                >
                                    $ {getRoundValue(item.commission, 2)}
                                </div>
                                <div
                                    className={classNames(
                                        styles.itemClosingDate,
                                        styles.footerItems
                                    )}
                                >
                                    {this.getTime(item.closedAt)}
                                </div>
                            </div>
                        ))}
                </div>
