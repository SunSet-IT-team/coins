...
class MenuButton extends Component {
    ...
    componentDidMount() {
        ...
        this.props.getMessageHistory().then((messages) => {
            this.setState({
                unvisitedMessages: messages.filter(
                    (item) => item.senderId === 'admin' && !item.visited
                ).length,
            });
        });
    }
    ...
    handleTransactionPopup = () => {
        this.props.setTransactionsPopup(true);
        this.handleOutsideClick();
    };
    ...
    handleSetLanguage = (currentLanguage) => {
        ...
        const item = _find(COUNTRY_INFO, {name: currentLanguage.countryCode});
        this.setState({
            currentLanguage: {id: currentLanguage.id, name: currentLanguage.name, flag: item.flag},
        });
    ...
    render() {
        ...
        return (
            <div>
                ...
                >
                    {isChatOpen ? (
                        <ChatPage closeChatHandler={this.handlerMenu} />
                    ) : (
                        <div>
                            ...
                            {user ? (
                                <div className={styles.contentContainer}>
                                    <div className={styles.contentItem}>
                                        <a target="_blank" href="https://pro100-capital.ru">
                                    ...
                                    <div className={styles.contentItem}>
                                        <div
                                            className={styles.contentItemText}
                                            onClick={this.handleAccountInfoPopup}
                                        >
                                            <div className={styles.iconContainer}>
                                                <svg
                                                    width="20"
                                    ...
                                    <div className={styles.contentItem}>
                                        <div
                                            className={styles.contentItemText}
                                            onClick={this.handleDepositPopup}
                                        >
                                            <div className={styles.iconContainer}>
                                                <svg
                                                    xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <div className={styles.contentItem}>
                                        <div
                                            className={styles.contentItemText}
                                            onClick={this.handleTransactionPopup}
                                        >
                                            <div className={styles.iconContainer}>
                                                <svg
                                                    width="24"
                                    ...
                                    <div
                                        className={classNames(
                                            styles.contentItem,
                                            styles.languagesSelectorMargin
                                        )}
                                    >
                                        <div className={styles.contentItemTextLang}>
                                            <div
                                                className={
                                                    stylesPrivateDataFormPopup.countryContainerField
                                                }
                                            ...
                                            >
                                                ...
                                                />
                                                <div
                                                    className={stylesPrivateDataFormPopup.topLabel}
                                                >
                                                    {text.language}
                                                </div>
                                            </div>
                                        ...
                                        <div className={styles.contentItemTextLang}>
                                            ...
                                            >
                                                ...
                                                <div
                                                    className={stylesPrivateDataFormPopup.topLabel}
                                                >
                                                    {text2.inputs.country.placeholder}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                >
                    <img
                        ...
                        src="/src/apps/client/ui/components/MenuButton/images/activeButton.svg"
                        alt=""
                    />
                    <div
                    ...
                    {!isMenuOpen ? (
                        ...
                        <div className={classNames(styles.button, styles.activeButtonText)}>
                            {text.menuTitleClose}
                        </div>
                    )}
                </div>
