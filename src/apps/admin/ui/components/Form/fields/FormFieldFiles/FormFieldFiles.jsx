...
const FilePreview = SortableElement(({file, i, classes, onFileDelete, isSorting}) => (
    ...
    >
        <div className={classes.fileItemDeleteContainer}>
            <IconButton aria-label="Delete" onClick={onFileDelete(i)}>
                <DeleteIcon />
            </IconButton>
        </div>
...
const FilesPreviews = SortableContainer(({files, classes, ...rest}) => {
    return (
        <div className={classes.filesList}>
            {files.map((file, i) => (
                <FilePreview key={i} index={i} i={i} file={file} classes={classes} {...rest} />
            ))}
        </div>
    );
});
            ...
            map((file) => {
                return new Promise((resolve) => {
                    ...
                    reader.onloadend = async () => {
                        ...
                        return this.props.uploadFile(fileInfo).then((path) => {
