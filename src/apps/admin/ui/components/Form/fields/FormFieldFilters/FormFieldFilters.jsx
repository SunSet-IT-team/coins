...
const Filter = SortableElement(
    ({
        ...
        return (
            <FormGroup
                className={classNames(classes.filter, {[classes.filterIsSortable]: isSorting})}
                row
            >
                        ...
                        {filter.type === 'checkbox' && (
                            <div>
                                <TextField
                                    ...
                                    value={
                                        (!isEditable
                                            ? newOptionTexts[filterIndex].name
                                            : editableOptionText) || ''
                                    }
                                    onChange={
                                        !isEditable
                                            ? onFilterNewOptionChange(filterIndex)
                                            : onFilterEditOptionChange
                                    }
                                    margin="normal"
                                    variant="outlined"
                                ...
                                {!isEditable ? (
                                    <Fab
                                        ...
                                        onClick={onFilterOptionAdd(filterIndex)}
                                        aria-label="Add"
                                    >
                                        <AddIcon />
                                    </Fab>
                                    ...
                                    [
                                        <Fab
                                            ...
                                            color="primary"
                                            className={classes.actionOptionButton}
                                            onClick={onFilterOptionEditDone}
                                            aria-label="Edit"
                                            key={0}
                                        >
                                            <CheckIcon />
                                        ...
                                        <Fab
                                            ...
                                            color="primary"
                                            className={classes.actionOptionButton}
                                            onClick={onFilterOptionEditCancel}
                                            aria-label="Cancel"
                                            key={1}
                                        >
                                            <CloseIcon />
                                    ...
                                    {filter.options &&
                                        filter.options.map((option, i) => (
                                            <Chip
                                                ...
                                                label={option.name}
                                                variant={
                                                    (!isEditable || editableOptionIndex !== i) &&
                                                    'outlined'
                                                }
                                                color="primary"
...
const Filters = SortableContainer(({filters, classes, ...rest}) => (
    <div className={classes.filtersWrapp}>
        {filters.map((filter, i) => (
            <Filter key={i} index={i} filterIndex={i} filter={filter} {...rest} classes={classes} />
        ))}
    </div>
));
...
class FormFieldFilters extends Component {
    ...
    handleFilterAdd = () => {
        ...
        this.props.onChange([...value, {name: '', type: '', id: uniqid()}]);
        this.setState({
            newOptionTexts: [...newOptionTexts, {name: ''}],
        });
    };
    ...
    handleFilterOptionAdd = (i) => () => {
        ...
        newValue[i].options = [
            ...newValue[i].options,
            {id: uniqid(), name: newOptionTexts[i].name},
        ];
