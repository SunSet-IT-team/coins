...
import { CHART_SYMBOL_INFO_MAP, CRYPTO_CURRENCIES_SYMBOLS } from '../../../../../../server/constants/symbols';
...
class ChartChangeForm extends Component {
  constructor(props) {
    ...
    this.initialValues = {
      ...
      priceWithOffset: assetPriceWebsocketController.prices[CRYPTO_CURRENCIES_SYMBOLS[0].name],
      priceOffset: '',
    }
  ...
  handleChange = (values, changes) => {
    ...
    switch (changeKey) {
      case 'assetName':
        ...
        updatedFormData.priceWithOffset = currentPrice + Number(updatedFormData.priceOffset)
        break;
      
      case 'priceOffset':
        updatedFormData.priceWithOffset = updatedFormData.currentPrice + Number(changeValue)
        break;
    }
