...
class ProductFilters extends Component {
    ...
    handleSearchSubmit = (event) => {
        ...
        this.props.search(this.state.search).then(() => {
            this.setState({
                searchDisabled: true,
            });
    ...
    handleActivityChange = (prop) => (event, value) => {
        ...
        const newFilters = {
            ...
            activity: (product) => {
                return (
                    (product.hidden && includes('hidden', selectedActivities)) ||
                    (!product.hidden && includes('active', selectedActivities))
                );
            },
        };
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(withStyles(materialStyles)(ProductFilters));
