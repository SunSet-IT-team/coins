...
class DatabasePage extends Component {
    ...
    handleDownloadDb = () => {
        this.props.downloadDb().then((url) => {
            const link = document.createElement('a');
            const fileName = compose(last, split('/'))(url);
    ...
    handleDownloadFiles = () => {
        this.props.downloadFiles().then((url) => {
            const link = document.createElement('a');
            const fileName = compose(last, split('/'))(url);
    ...
    handleUploadDb = () => {
        ...
        return this.props.uploadDb(formData).then(() => {
    ...
    handleUploadFiles = () => {
        ...
        return this.props.uploadFiles(formData).then(() => {
