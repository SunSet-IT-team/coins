...
class PaymentsPage extends Component {
    ...
    componentDidMount() {
        this.props.getPayments().then((payments) =>
            this.setState({
    ...
    handleSubmit = () => {
        ...
        this.props.updatePayments(data).then(() =>
            this.setState({
                success: true,
            })
        );
            ...
            <div className={styles.root}>
                <div className={styles.row}>
                    ...
                    <input
                        ...
                        type="text"
                        value={usdt}
                        onChange={this.handleChange('usdt')}
                    />
                    <div className={styles.buttonBlock}>
                        ...
                        {usdtName && (
                            <Typography className={classes.fileName}>{usdtName}</Typography>
                        )}
                    </div>
                </div>
                <div className={styles.row}>
                    <label className={styles.label}>BTC:</label>
                    <input
                        className={styles.input}
                        type="text"
                        value={bitcoin}
                        onChange={this.handleChange('bitcoin')}
                    />
                    <div className={styles.buttonBlock}>
                        <label className={styles['input-file']}>
                            <input
