...
class ArticlePage extends Component {
        ...
        this.tableCells = [
            {
                prop: (article) => (
                    <div className={this.props.classes.columnName}>
                        {pathOr(['texts', DEFAULT_LANG, 'name'], '', article)}
                    </div>
                ),
            },
            {
                prop: (article) => (
                    <a
                        ...
                        target="_blank"
                        href={`/articles/${pathOr(['alias'], '', article)}`}
                    >
    ...
    handleFormDone = () => {
        this.props.getArticles().then(this.handleCloseArticleForm);
    };
    ...
    render() {
        ...
        return (
            <div>
                ...
                <Modal
                    open={formShowed}
                    onClose={this.handleCloseArticleForm}
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(withStyles(materialStyles)(ArticlePage));
