...
export default [
    ...
    { id: 'messages', path: `${ADMIN_PANEL_URL}/settings`, exact: true, title: 'Настройки', adminOnly: true },
    ...
    { id: 'payments', path: `${ADMIN_PANEL_URL}/payments`, exact: true, title: 'Реквизиты', adminOnly: true },
    { id: 'moneyOutput', path: `${ADMIN_PANEL_URL}/outputs`, exact: true, title: 'Запросы на вывод' },
    { id: 'reload', path: `${ADMIN_PANEL_URL}/reload`, exact: true, title: 'Перезагрузить сервер', adminOnly: true }
];
