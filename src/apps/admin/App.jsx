...
const mapDispatchToProps = (dispatch) => ({
  ...
  getUnvisitedMoneyOutput: (payload) =>
    dispatch(getUnvisitedMoneyOutput(payload)),
  getUnvisitedMessageHistory: (payload) =>
    dispatch(getUnvisitedMessageHistory(payload)),
})
...
class App extends Component {
  ...
  componentDidMount() {
    ...
    outputWebsocketController.events.on(
      "output",
      this.props.getUnvisitedMoneyOutput
    )
      ...
      <main className={styles.stop}>
        ...
        <Switch>
          ...
          <Route
            ...
            render={(props) =>
              this.renderProtectedRoute(CredentialsPage, props)
            }
          />
          <Route
            exact
            path={`${ADMIN_PANEL_URL}/db`}
            component={DatabasePage}
          />
          <Route
            exact
            path={`${ADMIN_PANEL_URL}/outputs`}
