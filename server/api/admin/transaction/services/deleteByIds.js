        ...
        .then((transactions) => {
            ...
            for (const transaction of transactions) {
                !transactionsByType[transaction.type]
                    ? (transactionsByType[transaction.type] = transaction.value)
                    : (transactionsByType[transaction.type] += transaction.value);
            }
            ...
            if (
                user.credFacilities > 0 &&
                transactionsByType.credFacilities &&
                transactionsByType.credFacilities > 0
            ) {
            ...
            if (
                ...
                return res
                    ...
                    .send({error: 'Значение не может быть отрицательным'});
            }
